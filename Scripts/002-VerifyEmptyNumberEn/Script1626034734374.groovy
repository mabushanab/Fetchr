...
WebUI.verifyElementText(findTestObject('HomePage/label_TrackingNumberIsInvalid'), 'This tracking number is invalid.')

WebUI.verifyElementText(findTestObject('HomePage/label_TrackingNumberIsInvalid-Error'), 'Error')

WebUI.delay(5, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotVisible(findTestObject('HomePage/label_TrackingNumberIsInvalid'), FailureHandling.STOP_ON_FAILURE)
