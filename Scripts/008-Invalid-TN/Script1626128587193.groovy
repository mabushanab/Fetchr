...
WebUI.waitForElementPresent(findTestObject('HomePage/label_TrackingNumberIsInvalid-Error'), 30)

WebUI.verifyElementVisible(findTestObject('HomePage/label_TrackingNumberIsInvalid-Error'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('HomePage/label_TrackingNumberIsInvalid'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementText(findTestObject('HomePage/label_TrackingNumberIsInvalid'), GlobalVariable.InvalidTNmsg)
