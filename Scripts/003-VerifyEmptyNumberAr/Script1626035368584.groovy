...
WebUI.verifyElementText(findTestObject('HomePage/label_TrackingNumberIsInvalidAr'), 'رقم الشحنه غير صحيح')

WebUI.verifyElementText(findTestObject('HomePage/label_TrackingNumberIsInvalid-ErrorAr'), 'خطأ')

WebUI.delay(5, FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementNotVisible(findTestObject('HomePage/label_TrackingNumberIsInvalidAr'), FailureHandling.STOP_ON_FAILURE)
