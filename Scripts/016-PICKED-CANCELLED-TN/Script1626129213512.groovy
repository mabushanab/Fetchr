...
WebUI.setText(findTestObject('HomePage/textBox_Search'), GlobalVariable.TN6)
...
WebUI.verifyElementText(findTestObject('HomePage/label_CurrentStatusDescEn'), GlobalVariable.PICKEDCANCELLEDmsg)
