...
WebUI.setText(findTestObject('HomePage/textBox_Search'), GlobalVariable.TN5)
...
String temp = WebUI.getText(findTestObject('HomePage/label_CurrentStatusDescEn'), FailureHandling.STOP_ON_FAILURE)

if (!(temp.contains(GlobalVariable.ScheduledByCallcenterblind))) {
    assert false
}

WebUI.verifyElementVisible(findTestObject('HomePage/btn_OrderHistory'), FailureHandling.STOP_ON_FAILURE)

WebUI.verifyElementVisible(findTestObject('HomePage/btn_RescheduleOrder'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('HomePage/btn_OrderHistory'), 30)

WebUI.click(findTestObject('HomePage/btn_OrderHistory'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementPresent(findTestObject('HomePage/label_ShipmentActivity'), 30)

WebUI.verifyElementVisible(findTestObject('HomePage/label_ShipmentActivity'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('HomePage/btn_Exit'), 30)

WebUI.click(findTestObject('HomePage/btn_Exit'), FailureHandling.STOP_ON_FAILURE)

WebUI.waitForElementClickable(findTestObject('HomePage/btn_RescheduleOrder'), 30)

WebUI.click(findTestObject('HomePage/btn_RescheduleOrder'), FailureHandling.STOP_ON_FAILURE)
...
WebUI.verifyElementText(findTestObject('Delivery Location/label_TNNumber'), GlobalVariable.TN5)
