...
WebUI.setText(findTestObject('HomePage/textBox_Search'), GlobalVariable.TN3)
...
if (!(temp.contains(GlobalVariable.ScheduledByMweb))) {
    assert false
}
...
WebUI.verifyElementText(findTestObject('Delivery Location/label_TNNumber'), GlobalVariable.TN3)
